...
router.post('/', secured, followersController.createFollow);
...
router.post('/unfollow/:id', secured, followersController.unfollow);
router.get('/:followingId/:followedId', followersController.isFollowed);
