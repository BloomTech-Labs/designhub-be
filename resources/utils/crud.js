...
exports.createOne = (table, returning, object) => {
  return db(table).returning(returning).insert(object);
};
...
exports.updateById = (table, object, id) => {
  return db(table).update(object).where('id', id);
};

exports.updateByRawWhere = (table, object, whereQuery, whereBindingArray) => {
  return db(table).update(object).whereRaw(whereQuery, whereBindingArray);
};
