...
//project_categories
router.get('/projects/all', controller.getAllProjectCategories); //all categories that are assigned to projects
...
router.delete('/:id', secured, controller.deleteCategoryByProjectCategoryId); 
