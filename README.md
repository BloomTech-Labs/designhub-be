...
| GET    | `/api/v1/following/count/following/:id`  | N/A            | The id should reference the users id.              | req.params: { id }             | This will return the count of the total amount of people that the user is following based on the users.id |
...
=======
>>>>>>> 41c35f9d4a8aa7bbc46a5e018c2edae917b9b237
}
```
